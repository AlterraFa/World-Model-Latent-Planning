...
class MaskCollator(object):
    ...
    def __call__(self, batch):
        ...
        # -- There can be multiple masks config
        # Batch: [buffer, label, clip_indices]
        # -- fpc is frame per clips or frame per samples
        ...
        # -- [[(sub_B, H, W, buff_length, 3), (sub_B, ), (sub_B, buff_length)], [(sub_B, num_enc1), (sub_B, num_enc2), ...], [(sub_B, num_pred1), (sub_B, num_pred2)]]
    ...
    def __call__(self, batch_size):
        ...
        for _ in range(batch_size):
            ...
            while empty_context:
                ...
                # -- npred is now the number of tries to create pred masks
                # -- the masks can now overlap each other, making it easier to produce a mask unlike I-JEPA
